...
fsweep::DesktopView::DesktopView(fsweep::GameModel& game_model) noexcept : game_model(std::ref(game_model)) {}
...
fsweep::GameModel& fsweep::DesktopView::GetGameModel() noexcept { return this->game_model.get(); }
